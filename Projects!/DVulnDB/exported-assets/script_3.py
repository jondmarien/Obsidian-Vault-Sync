...
ivulnerability_registry = '''// SPDX-License-Identifier: MIT
...
ibounty_escrow = '''// SPDX-License-Identifier: MIT
pragma solidity ^0.8.19;
...
with open('dvulndb-prototype/contracts/interfaces/IVulnerabilityRegistry.sol', 'w') as f:
    f.write(ivulnerability_registry)

with open('dvulndb-prototype/contracts/interfaces/IBountyEscrow.sol', 'w') as f:
    f.write(ibounty_escrow)

print("Interfaces created!")

# Create ReputationNFT contract (ERC-721 based reputation system)
reputation_nft_sol = '''// SPDX-License-Identifier: MIT
pragma solidity ^0.8.19;
...
with open('dvulndb-prototype/contracts/ReputationNFT.sol', 'w') as f:
    f.write(reputation_nft_sol)

print("ReputationNFT contract created!")