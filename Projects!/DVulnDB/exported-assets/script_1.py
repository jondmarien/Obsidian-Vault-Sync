# Create the main VulnerabilityRegistry smart contract
vulnerability_registry_sol = '''// SPDX-License-Identifier: MIT
...
with open('dvulndb-prototype/contracts/VulnerabilityRegistry.sol', 'w') as f:
    f.write(vulnerability_registry_sol)

print("VulnerabilityRegistry contract created!")